    ...
    <div className="booking container">
      <div className="booking checkinAll">
        <div className="booking checkinContainer">
          <div className="booking check">Check-in</div>
        ...
        <div className="booking checkoutContainer">
          <div className="booking check">Check-out</div>
          <div className="booking date">
            <FormField
      ...
      <BaseContainer>
        ...
        <div className="carpark header">
          ...
          <div className="carpark empty">
            {" "}
            {ParkingData.numOfEmptySpaces}/{ParkingData.maxCapacity}
          </div>
        </div>
        ...
        <div className="carpark adressAndHours ">
          ...
          <div className="carpark leftElement">
            <div className="carpark elementTitle">Adress</div>
            <div className="carpark Details">
              <div className="carpark street">{ParkingData.street}</div>
              <div className="carpark zip">{ParkingData.zipCode}</div>
              <div className="carpark city">{ParkingData.city}</div>
            </div>
          </div>

          {/*------------------- hours --------------------- */}
          <div className="carpark rightElement">
            <div className="carpark elementTitle">Opening Hours</div>
            <div className="carpark Details">
              <div className="carpark weekTitle">Weekdays</div>
              <div className="carpark week">
                {ParkingData.weekdayOpenFrom} to {ParkingData.weekdayOpenTo}
              </div>
              <div className="carpark weekTitle">Weekend</div>
              <div className="carpark week">
        ...
        <div className="carpark tariffAndRemarks">
          {/*------------------- tariff --------------------- */}
          <div className="carpark leftElement">
            <div className="carpark elementTitle">Tariff</div>
            <div className="carpark Details">
          ...
          {/*------------------- remarks --------------------- */}
          <div className="carpark rightElement">
            <div className="carpark elementTitle">Remarks</div>
            <div className="carpark Details">
              <div className="carpark street">{ParkingData.remarks}</div>
            </div>
          </div>
        </div>
